...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer" ClientIDMode="Predictable" runat="server"></rsweb:ReportViewer>--%>
          <asp:ScriptManager runat="server" ScriptMode="Release" EnablePartialRendering="false" ></asp:ScriptManager>
        <rsweb:ReportViewer ID="ReportViewer" runat= "server"></rsweb:ReportViewer>

                   <script type="text/javascript" language="javascript">
                       $(document).ready(function () {
                           var reportDiv = $("div[id$='oReportDiv']").css("overflow", "inherit")[0];
                           //var reportDiv1 = $("div[id$='ct109']").css("overflow", "")[0];
                           if (reportDiv != null) {
                             reportDiv.parentElement.parentElement.parentElement.parentElement.style.overflow = "";
                           }
                       });
